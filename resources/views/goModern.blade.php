    ...
    <div class="flex gap-x-5 px-10">
        <div class="border-2 rounded-lg p-5 w-2/12 h-32 text-gray-700">
            <ul>
                ...
                <li class="font-bold"><a href="{{ route('goModern') }}">GoModern</a></li>
                <li><a href="{{ route('goGlobal') }}">GoGlobal</a></li>
            </ul>
        </div>
        <div class="card w-10/12 bg-base-100 shadow-xl image-full mr-5 ml-5 h-64 bg-center bg-cover bg-no-repeat" style="background-image: url('{{ asset('assets/online.jpg') }}')">
