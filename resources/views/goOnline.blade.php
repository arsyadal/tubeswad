...
<body class="bg-gray-50">
    ...
    <div class="flex gap-x-5 px-10">
        <div class="border-2 rounded-lg p-5 w-2/12 h-32 text-gray-700">
            <ul>
                <li class="font-bold"><a href="{{ route('goOnline') }}">GoOnline</a></li>
                <li><a href="{{ route('goModern') }}">GoModern</a></li>
                <li><a href="{{ route('goGlobal') }}">GoGlobal</a></li>
            </ul>
        </div>
        <div class="card w-10/12 bg-base-100 shadow-xl image-full mr-5 ml-5 h-64 bg-center bg-cover bg-no-repeat" style="background-image: url('{{ asset('assets/kelass2.jpg') }}')">
    ...
    <div class="flex justify-end p-10 ml-14">
        <div class="card w-10/12 bg-[#133256] shadow-xl image-full  mr-5 ml-5">
            <div class="card-body bg-[#133256] rounded-xl text-white">
                <h2 class="card-title text-white">Go Modern</h2>
